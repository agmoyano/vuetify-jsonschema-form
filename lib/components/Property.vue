<template>
  ...
  <v-flex v-if="fullSchema && fullSchema.const === undefined && fullSchema['x-display'] !== 'hidden'" :class="propertyClass" :style="fullSchema['x-style'] || ''">
    <slot :name="`prepend-${slotName}`" :schema="schema" :fullKey="fullKey" :fullSchema="fullSchema" :modelWrapper="modelWrapper" :modelKey="modelKey" :model="modelWrapper[modelKey]" :required="required" :disabled="disabled" :rule="rules" :options="options" :modelRoot="modelRoot" :htmlDescription="htmlDescription" />
    <slot :name="slotName" :schema="schema" :fullKey="fullKey" :fullSchema="fullSchema" :modelWrapper="modelWrapper" :modelKey="modelKey" :model="modelWrapper[modelKey]" :required="required" :disabled="disabled" :rule="rules" :options="options" :modelRoot="modelRoot" :htmlDescription="htmlDescription">
      <!-- Date picker -->
    ...
    <slot :name="`append-${slotName}`" :schema="schema" :fullKey="fullKey" :fullSchema="fullSchema" :modelWrapper="modelWrapper" :modelKey="modelKey" :model="modelWrapper[modelKey]" :required="required" :disabled="disabled" :rule="rules" :options="options" :modelRoot="modelRoot" :htmlDescription="htmlDescription" />
  </v-flex>
</template>
